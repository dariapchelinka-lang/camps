...
def _load_service_account_credentials():
    ...
    credentials_json_b64 = os.getenv("GOOGLE_SERVICE_ACCOUNT_JSON_B64")
    ...
    if credentials_json_b64:
        try:
            credentials_json = base64.b64decode(
                credentials_json_b64, validate=True
            ).decode("utf-8")
        except (ValueError, UnicodeDecodeError) as error:
            raise GoogleSheetsError(
                "Секрет GOOGLE_SERVICE_ACCOUNT_JSON_B64 содержит некорректный "
